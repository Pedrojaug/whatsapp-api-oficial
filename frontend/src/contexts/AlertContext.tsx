    ...
    <AlertContext.Provider value={{ showAlert }}>
      ...
      {alert && (
        <div className="fade-in app-alert" style={{
          ...
          background: alert.type === "success" ? "rgba(16, 185, 129, 0.92)" : alert.type === "error" ? "rgba(239, 68, 68, 0.92)" : "rgba(59, 130, 246, 0.92)",
          color: "#fff", backdropFilter: "blur(8px)", boxShadow: "0 10px 30px rgba(0, 0, 0, 0.35)",
          maxWidth: "420px",
        }}>
          {alert.type === "success" ? "✅" : alert.type === "error" ? "⚠️" : "ℹ️"} {alert.text}
        </div>
      )}
